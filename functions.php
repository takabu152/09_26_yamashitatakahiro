...
function menu($flg)
{
    if ($flg == 2) {
        ...
        //ユーザーメニュー
        //$menu = '<li class="nav-item"><a class="nav-link" href="login.php">ログインページ</a></li><li class="nav-item"><a class="nav-link" href="select.php">todo一覧</a></li>';
        ...
        $menu .= '<li class="nav-item"><a class="nav-link" href="user_index.php">User登録</a></li><li class="nav-item"><a class="nav-link" href="user_select.php">User管理</a></li>';
